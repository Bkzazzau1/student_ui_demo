...
void main() {
  testWidgets('assignment submission view submits typed answer', (
    tester,
  ) async {
            ...
            body: ElevatedButton(
              onPressed: () async {
                result = await Navigator.of(context)
                    .push<AssignmentSubmissionResult>(
  ...
  testWidgets('assignment submission view can attach demo file', (
    tester,
  ) async {
    ...
    await tester.pumpWidget(
      MaterialApp(home: AssignmentSubmissionView(assignment: assignment)),
    );
