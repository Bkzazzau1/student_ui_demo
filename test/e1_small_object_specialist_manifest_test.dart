...
void main() {
  ...
  test(
    'bundled specialist slot is valid but explicitly not installed',
    () async {
  ...
  test('installed specialist requires real model provenance and classes', () {
    final invalid = E1SmallObjectSpecialistManifest.fromJson(<String, Object?>{
  ...
  test('complete installed manifest produces an explicit native policy', () {
    final manifest = E1SmallObjectSpecialistManifest.fromJson(<String, Object?>{
      'manifest_schema_version': '1.0',
      'installed': true,
      'model_id': 'e1-small-object-specialist',
      'model_version': '1.0.0',
      'model_path': 'assets/models/e1_small_object_specialist/model.int8.onnx',
      'precision': 'int8',
