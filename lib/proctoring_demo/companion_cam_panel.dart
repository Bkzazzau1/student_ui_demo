...
class _CompanionCamPanelState extends State<CompanionCamPanel> {
  ...
  Timer? _heartbeat;
  String _status = 'Start companion camera for exam monitoring.';
  ...
  Future<void> _start() async {
    ...
    setState(() {
      _starting = true;
      _status = 'Creating local camera pairing...';
    });
    try {
      ...
      setState(() {
        ...
        _starting = false;
        _connected = false;
        _status = 'Scan pairing code with phone on same Wi-Fi. Place phone behind or beside you.';
      });
      await _sendEvent(
        eventType: 'companion_cam_qr_generated',
        severity: 'info',
        message: 'Companion camera pairing code generated.',
      ...
      setState(() {
        _starting = false;
        _status = 'Companion camera could not start.';
      });
      await _sendEvent(
        eventType: 'companion_cam_server_failed',
        severity: 'warning',
        message: 'Companion camera local service could not start.',
  ...
  void _onConnectionChanged(bool connected) {
    ...
    setState(() {
      ...
      _status = connected
          ...
          : 'Companion camera disconnected. Re-scan code or keep phone awake.';
    });
    unawaited(
      _sendEvent(
        eventType: connected
  ...
  void _checkHeartbeat() {
    ...
    if (_connected &&
      ...
      setState(() {
        _connected = false;
        _status = 'Companion camera feed is not updating. Keep phone awake.';
      });
      unawaited(
        _sendEvent(
      ...
      widget.onCompanionLost(
        'Companion camera feed stopped. Keep phone camera connected for this exam.',
      );
    }
  }
  ...
  Future<void> _sendEvent({
    ...
    final enrichedMetadata = <String, Object?>{
      ...
      'source_component': 'companion_cam_panel',
    };
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Local Wi-Fi only • no cloud streaming',
